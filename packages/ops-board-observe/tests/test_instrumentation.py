...
PROVIDER_ENV_CASES = [("OTEL_PYTHON_TRACER_PROVIDER", "tracer provider"), ("OTEL_PYTHON_LOGGER_PROVIDER", "logger provider")]
...
def test_bootstrap_rejects_env_configured_provider_intent(monkeypatch: pytest.MonkeyPatch, env_var: str, message: str) -> None:
...
class _NoopSpanExporter:
    ...
    def export(self, *args: object, **kwargs: object) -> SpanExportResult: return SpanExportResult.SUCCESS

    def shutdown(self, *args: object, **kwargs: object) -> None: return None

    def force_flush(self, *args: object, **kwargs: object) -> bool: return True


class _NoopLogExporter:
    def __init__(self, *args: object, **kwargs: object) -> None: pass

    def export(self, *args: object, **kwargs: object) -> LogExportResult: return LogExportResult.SUCCESS
...
class _SlowNoopSpanExporter(_NoopSpanExporter):
    def __init__(self, *args: object, **kwargs: object) -> None: time.sleep(0.05); super().__init__(*args, **kwargs)
...
class _RaisingHandler(logging.Handler):
    def emit(self, record: logging.LogRecord) -> None: raise RuntimeError("handler boom")
...
class _ReplacingLock:
    ...
    def __enter__(self) -> None: self._replace()
